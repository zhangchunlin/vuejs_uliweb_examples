...
setup(
    name='vuejs_uliweb_examples',
    version=grep('__version__'),
    url=grep('__url__'),
    license='BSD',
    author=grep('__author__'),
    author_email=grep('__email__'),
    description='vuejs_uliweb_examples',
    long_description=desc(),
    package_dir = {'vuejs_uliweb_examples':'apps'},
    packages = ["vuejs_uliweb_examples"],
